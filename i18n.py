...
STRINGS: dict[str, dict[str, str]] = {
    "pt-BR": {
        ...
        "clock.cents.label": "compute",
        "clock.cents": "R${n} em compute",
        "resume.back": "Fechar",
        "resume.name": "Chat",
        "resume.web": "web",
        "resume.ssh": "ssh",
        ...
        "referral.left": "faltam {n} amigos pro Pix",
        "referral.ready": "comissão ≥ R$5 · Pix no mesmo trilho",
        ...
        "rail.1.k": "01 · paga",
        "rail.1.t": "um clique. Pix R$5.",
        "rail.1.p": "5h de GROK 4.6 High Fast. Sem cadastro. Sem segundo caixa.",
        "rail.2.k": "02 · guarda",
        "rail.2.t": "wdtsot-XXXX",
        "rail.2.p": "O código do bloco é o login das 5h.",
        "rail.3.k": "03 · indica",
        "rail.3.t": "o mesmo ?code=",
        "rail.3.p": "10% em compute. Teto: 10 amigos pro Pix. Primeiro indicador: fuzzy.",
        ...
        "faq.a6": "O mesmo card R$5 / 5h. Dez links conta.vc no painel <a href=\"#vender\">Venda seus tokens</a>. Skill opcional: título + manifesto + CLI do allowlist. O primeiro nome na prateleira continua fuzzy. O pedido entra em revisão — o estoque é sagrado. Sem segundo caixa.",
        ...
        "modal.invite.h": "Manda este link",
        "modal.invite.p": "O mesmo código do bloco. Sem e-mail. 10% em compute. Pix aos R$5.",
        "modal.invite.later": "agora não",
        "modal.invite.ok": "copiar e fechar",
        "sell.close": "fechar",
        ...
        "sell.skill.title": "skill: título curto (opcional)",
        "sell.skill.manifesto": "skill: manifesto curto (opcional, ≤280)",
        "sell.skill.cli": "skill: CLI (opcional — cursor, codex, claude, antigravity, metamuse)",
    ...
    "en-US": {
        "title": "spare tokens — we deserve to share our tokens",
        "description": "Leftover-token marketplace. BR: R$5 · 5h Pix. Outside BR: from ~$1 USDT on the same shelf for 5h. Invite ?code=, reseller fuzzy. No subscription.",
        ...
        "pay.note": "Brazil: one-step Pix R$5. Outside BR: from ~$1 USDT via the same conta.vc shelf for the same 5h. The block code is the login — and the same <code>?code=</code> is the invite.",
        ...
        "referral.left": "{n} friends left until Pix",
        "referral.ready": "commission ≥ R$5 · Pix on the same rail",
        ...
        "rail.1.k": "01 · pay",
        "rail.1.t": "one click. Pix R$5 · from ~$1 USDT",
        "rail.1.p": "Same 5h GROK block. No signup. No second till.",
        "rail.2.k": "02 · keep",
        "rail.2.t": "wdtsot-XXXX",
        "rail.2.p": "The block code is the 5-hour login.",
        "rail.3.k": "03 · invite",
        "rail.3.t": "the same ?code=",
        "rail.3.p": "10% in compute. Ceiling: 10 friends until Pix. First indicator: fuzzy.",
        ...
        "faq.a1": "Same 5 hours of GROK 4.6 High Fast. Brazil: R$5 Pix. Outside BR: from ~$1 USDT on the same conta.vc shelf (fixed SKU mint still pending). No subscription.",
        ...
        "faq.a6": "The same R$5 / 5h card. Ten conta.vc links in the <a href=\"#vender\">Sell your tokens</a> panel. Optional skill: title + manifesto + allowlist CLI. The first name on the shelf stays fuzzy. The request is queued for review — live stock is sacred. No second till.",
        "split.open.h": "Built in the open.",
        ...
        "modal.invite.h": "Send this link",
        "modal.invite.p": "The same block code. No email. 10% in compute. Pix at R$5.",
        "modal.invite.later": "not now",
        "modal.invite.ok": "copy and close",
        "sell.close": "close",
        ...
        "sell.skill.title": "skill: short title (optional)",
        "sell.skill.manifesto": "skill: short manifesto (optional, ≤280)",
        "sell.skill.cli": "skill: CLI (optional — cursor, codex, claude, antigravity, metamuse)",

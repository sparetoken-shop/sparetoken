...
Produto no ar: **0.2.41**. Pulsos **11:30 venda** e **23:30 produto**. Login = código do bloco. Cada pulso planta D+8. Sem publicação de manhã, a venda falhou — **não** some o D+8.
...
| D24 | 22/09 | **plantado 14/09 23:30:** se o refill +10 do Mac entrou e o pool voltou a ≥3, a linha do pulso mostra N Open; se ainda 0, o `0 Open · restock` continua no pulso sem esconder o rail — sem mint na VPS, sem segundo caixa | o refill do Mac moveu o pool ou o pulso segue em restock? | D32: se o pool voltar a esvaziar <3, o CEO lembra refill de novo; o número nunca entra no card |
| D25 | 23/09 | **plantado 15/09 23:30:** se atribuição fechada ainda for 0, o ledger continua invite-only (D17 trava, card apagado). Se ≥1 paid, o card acende o contador (D10 já deixa) — ainda sem tela de pessoas; centavos no relógio só se accrued > 0 e < 5 | o ledger no invite moveu atribuição fechada ou só texto? | D33: se o 1º amigo pagar, o invite mostra faltam N e o card acende; senão o lock continua |
| D26 | 24/09 | **plantado 16/09 23:30:** se atribuição fechada ainda for 0, o popup continua só depois do claim (D18 trava, nunca primeira dobra). Se ≥1 paid, o invite da dobra pode citar o link — ainda sem `?ref=` extra, ainda sem tela de pessoas | o popup pós-claim moveu atribuição fechada ou só claim_ok? | D34: se closed ainda for 0, o `?ref=` continua fora da dobra; se ≥1 paid, o `?ref=` entra ao lado do `?code=` login |

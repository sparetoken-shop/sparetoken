...
| D6 | 06/09 | Open count no pulso + regressão do sweep — **SHIP 0.2.28**. Restock continua a skill no Mac, sem mint na VPS | Idle GPU markets — por que a gente vende *hora de modelo*, não H100 | Sweep automático do pool |

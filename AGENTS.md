...
**CEO BOARD (2026-09-04):** leia `ceo/BOARD.md` antes de commitar. Oracle está no X (@sparetoken). A loja é pt-BR / en-US (bandeiras BR e US, IP do dispositivo). Cripto/USDT na conta.vc está no roadmap curto — **não** é um segundo caixa. Pix R$5 / 5h intacto.
...
1d. **Publish-or-delete:** após 50 tentativas de publish validadas pela tríade (CEO/Oraculus/Groko) com zero permalinks vivos, este repo é deletado/arquivado — projeto concedido. Ver `.cursor/rules/publish-or-delete.mdc` + `ceo/PUBLISH-KILL-SWITCH.md`. VNC/noVNC proibido como handoff. Sem segundo caixa sem charge Open USDT.
